...
if (isset($_POST['addCompany'])) {
    ...
    if (empty($title) || $title === '') {
        $error = "Company Title is Required";
    } else {
        ...
        if ($countRow > 0) {
            $error = "A company already exists with the same title";
        } else {
            ...
            if ($flag == 0 && $flag2 == 0) {
                ...
                $sqlInsertCompany = "INSERT INTO company SET $customArray";
                ...
                if ($resultInsertCompany) {
                    ...
                    $title = $detail = $site_link = '';
                } else {
                    $error = "Company information addition failed for " . mysqli_error($con);
                }
            }
        }
    }
...
<html>
    <head>
        ...
        <title>Hydeventures - Add Company</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-building"></i>&nbsp;Add New Company Information</div>
        ...
        <script type="text/javascript">
            $("#addCompanyActive").addClass("active");
            $("#addCompanyActive").parent().parent().addClass("treeview active");
            $("#addCompanyActive").parent().addClass("in");
        </script>
    </body>
</html>