...
$sql = "SELECT buy_requirement.*, category.*, country.*, keyword.*, member.* FROM buy_requirement "
        ...
        . "WHERE buy_requirement_status = '0'";
$result = mysqli_query($con, $sql)or die(mysqli_error($con));

// User Active
if (isset($_POST['ActiveBuyReqPost'])) {
    extract($_POST);

    $sql = "UPDATE buy_requirement SET buy_requirement_status='1' WHERE buy_requirement_id=$buy_requirement_id";
    $result = mysqli_query($con, $sql);
    if ($result) {
        $success = "Buy requirement post published successfully";
    } else {
        $error = "Something went wrong. Please try again.";
    }
}
...
<html>
    <head>
        ...
        <title>Pending Buyer Request List</title>
                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-dashboard"></i>&nbsp; All Pending Buyer Request List</div>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 20%;">
                                                                    <a href="javascript:void(0);">
                                                                        <button class="btn btn-warning btn-sm" data-toggle="modal" type="button" data-target="#activeUser<?php echo $buyRequirmentList['buy_requirement_id']; ?>" title="Click to publish Post"><i class="fa fa-check-circle-o"></i> Publish Post</button>
                                                                    </a>
                                                                    <a href="javascript:void(0);">
