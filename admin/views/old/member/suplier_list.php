...
//Member list show
$sql = "SELECT * FROM member WHERE member_primary_business='2' AND member_status='1' ORDER BY member_id DESC";
$result = mysqli_query($con, $sql)or die(mysqli_error($con));
...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-dashboard"></i>&nbsp; All Seller List</div>
        ...
        <script type="text/javascript">
            $("#listSupplierActive").addClass("active");
            $("#listSupplierActive").parent().parent().addClass("treeview active");
            $("#listSupplierActive").parent().addClass("in");
        </script>
