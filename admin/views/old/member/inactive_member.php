...
//Member list show
$sql = "SELECT * FROM member WHERE member_status = '0' ORDER BY member_id DESC";
...
if (isset($_POST['ActiveMember'])) {
    ...
    $sql = "UPDATE member SET member_status='1' WHERE member_id=$member_id";
    $result = mysqli_query($con, $sql);
    if ($result) {
        $success = "Member account conformed successfully";
    } else {
        $error = "Something went wrong. Please try again.";
    }
}
...
<html>
    <head>
        ...
        <title>Inactive Member List</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-md-12">
                            <div class="panel-group">
                                <div class="panel panel-primary">
                                    <div class="panel-heading panel-style"><i class="fa fa-dashboard"></i>&nbsp; All Inactive Member List</div>
        ...
        <script type="text/javascript">
            $("#inactiveMemberActive").addClass("active");
            $("#inactiveMemberActive").parent().parent().addClass("treeview active");
            $("#inactiveMemberActive").parent().addClass("in");
        </script>
